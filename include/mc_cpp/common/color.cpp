...
namespace mc {
    ...
    auto multiplyColor(const RGBA &rgba, const float fr, const float fg, const float fb, const float fa) -> RGBA {
        return RGBA {
    ...
    auto multiplyColor(const RGBA &rgba, const float frgb, const float fa) -> RGBA {
    ...
    auto unpackARGB(const int32_t argb) -> RGBA {
        return RGBA {
    ...
    auto interpolate(const RGBA &rgba1, const RGBA &rgba2, const float interpolationValue) -> RGBA {
    ...
    auto interpolate(const std::vector<RGBA> &colors, const float interpolationValue) -> RGBA {
